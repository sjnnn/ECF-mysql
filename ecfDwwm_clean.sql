/*source C:/wamp64/www/mysql/ecfDwwm.sql;*/
/*
*********************************************************************
...
*********************************************************************
* Modifications
*   Epuration du fichier en retirant les commentaires superflus 
*   (pour nos propos).
*   Personnalisation du code.
*/
DROP DATABASE IF EXISTS ecfDwwm;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ecfDwwm /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE customers (
  ...
  CONSTRAINT customerNumber PRIMARY KEY (customerNumber), 
